  ...
  return (
    <div>
      <div className='rounded-lg overflow-hidden bg-white pb-6 shadow-md'>
        ...
        <div className='border-b border-gray-400 px-8'>
      ...
      <div className="flex gap-16 items-center mt-12">
        <button type="submit" className="btn text-white font-medium rounded-lg px-16 py-2.5 text-center" onClick={() => navigate('/purchase-completed')}>Pay</button>
