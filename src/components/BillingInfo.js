...
const BillingInfo = () => {
  ...
  return (
    <div>
      <form>
      <div class="mb-6">
        <label for="name" className="block mb-2 font-medium text-gray-900">Name on Card <span className='text-red-600'>*</span></label>
      ...
      <div className='mb-6'>
         <label for="card-type" className="block mb-2 font-medium text-gray-900">Card Type <span className='text-red-600'>*</span></label>
      ...
      <div class="grid gap-6 mb-6 md:grid-cols-3">
        <div>
            <label for="lg" className="block mb-2 font-medium text-gray-900">Card Details <span className='text-red-600'>*</span></label>
            <input type="text" id="lg" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5"/>
        </div>

        <div class="mb-6">
        <label for="address1" className="block mb-2 font-medium text-gray-900">Expiry Date <span className='text-red-600'>*</span></label>
      ...
      <div class="mb-6">
        <label for="address2" className="block mb-2 font-medium text-gray-900">CVV <span className='text-red-600'>*</span></label>
      ...
      <div className="flex gap-20 items-center">
        <button type="submit" class="btn text-white font-medium rounded-lg px-20 py-2.5 text-center" onClick={() => navigate('/payment/confirm-payment')}>Next</button>
